...
export const products: Product[] = [
  ...
  },
  {
    ...
    slug: "jedi-herbs",
    name: "Jedi Herbs",
    tagline: "Cleanse · digestion · system flush",
    price: 25000,
    category: "Tonics",
    group: "Herbals",
    image: infectionFlusherHerbs,
    ingredients: ["Brewed traditional Jedi herbal blend"],
    description:
      "A potent traditional Jedi herbal tonic that flushes the system, supports digestion, clears toxins and impurities, and promotes overall internal cleansing for both men and women.",
    ritual: "Take a small cup in the morning before eating and a cup at night after eating.",
  },
  {
    id: "32",
    slug: "man-power-herbs",
    name: "Man Power Herbs",
    tagline: "Stamina · vitality · performance",
    price: 25000,
    category: "Tonics",
    group: "Herbals",
    image: flusherDrink,
    ingredients: ["Brewed male vitality herbal blend"],
    description:
      "A natural herbal tonic crafted for men to boost stamina, vitality and overall sexual performance. Supports energy, endurance and confidence.",
    ritual: "Shake well. Take 30ml twice daily, morning and night.",
  },
  {
    id: "33",
    slug: "sperm-booster-herbs",
    name: "Sperm Booster Herbs",
    tagline: "Sperm count · motility · quality",
    price: 50000,
    category: "Tonics",
    group: "Herbals",
    image: infectionFlusherHerbs,
    ingredients: ["Brewed male fertility herbal blend (3 litres)"],
    description:
      "A 3-litre brewed herbal tonic that helps boost sperm count, improve motility and enhance overall sperm quality. Supports male fertility naturally.",
    ritual: "Comes with a measuring cup. Take a cup in the morning before eating and a cup at night after eating.",
  },
  {
    id: "34",
    slug: "man-fertility-herbs",
    name: "Man Fertility Herbs",
    tagline: "Reproductive health · fertility",
    price: 40000,
    category: "Tonics",
    group: "Herbals",
    image: pidHerbs,
    ingredients: ["Brewed male fertility herbal blend (3 litres)"],
    description:
      "A 3-litre brewed herbal tonic that supports male reproductive health, treats infections affecting fertility, and helps improve the chances of conception naturally.",
    ritual: "Comes with a measuring cup. Take a cup in the morning before eating and a cup at night after eating.",
  },
  {
    id: "35",
    slug: "fertility-booster-herbs",
    name: "Fertility Booster Herbs",
    tagline: "Conception support · ovulation",
    price: 30000,
    category: "Tonics",
    group: "Herbals",
    image: hormonalImbalance3L,
    ingredients: ["Brewed fertility herbal blend (3 litres)"],
    description:
      "A 3-litre brewed herbal tonic that boosts fertility, supports ovulation, balances hormones and prepares the body for conception. Suitable for women trying to conceive.",
    ritual: "Comes with a measuring cup. Take a cup in the morning before eating and a cup at night after eating.",
  },
  {
    id: "36",
    slug: "flat-tummy-drink-big",
    name: "Flat Tummy Drink (Big)",
    tagline: "Slim · debloat · detox",
    price: 20000,
    category: "Tonics",
    group: "Herbals",
    image: flusherDrink,
    ingredients: ["Brewed slimming herbal blend"],
    description:
      "A larger size of our Flat Tummy Drink — a natural herbal tonic that helps reduce belly fat, debloat, support digestion and gently detoxify the body.",
    ritual: "Shake well. Take 30ml in the morning on an empty stomach and 30ml at night before bed.",
  },
  {
    id: "37",
    slug: "flat-tummy-drink-small",
    name: "Flat Tummy Drink (Small)",
    tagline: "Slim · debloat · trial size",
    price: 10000,
    category: "Tonics",
    group: "Herbals",
    image: flusherDrink,
    ingredients: ["Brewed slimming herbal blend"],
    description:
      "Trial size of our Flat Tummy Drink — a natural herbal tonic that helps reduce belly fat, debloat, support digestion and gently detoxify the body.",
    ritual: "Shake well. Take 30ml in the morning on an empty stomach and 30ml at night before bed.",
  },
];
