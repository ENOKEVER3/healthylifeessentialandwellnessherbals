    ...
    <div className="bg-background">
      {bgmReady && (
        <button
          type="button"
          onClick={toggleMuted}
          aria-label={muted ? "Unmute background music (press M)" : "Mute background music (press M)"}
      ...
      <section className="container-narrow py-10 md:py-16">
        {loading ? (
          ...
          <>
            ...
            <AdSlot slot="2345678901" placement="reviews-mid" label="Sponsored content, between reviews" className="mt-10" />
