  ...
  if (reviews.length === 0) {
    return (
      <section className="mt-20 border-t border-border pt-14">
        <h2 className="font-display text-3xl text-moss-deep">Reviews</h2>
        <p className="mt-4 text-muted-foreground">No reviews yet — be the first to share your ritual.</p>
      </section>
    );
  }
  ...
  return (
    <section className="mt-20 border-t border-border pt-14">
      <div className="mb-12 grid gap-10 md:grid-cols-[1fr,1.4fr] md:gap-16">
        <div>
          <p className="text-xs uppercase tracking-[0.24em] text-ochre">From the community</p>
          <h2 className="mt-3 font-display text-4xl text-moss-deep">Reviews</h2>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Based on {summary.count} verified ritual{summary.count === 1 ? "" : "s"}
          </p>
        </div>
            ...
            <div className="text-sm">
              ...
              {r.verified && (
                <p className="mt-2 inline-flex items-center gap-1 text-[11px] uppercase tracking-[0.16em] text-moss">
                  <CheckCircle2 className="h-3 w-3" strokeWidth={1.6} /> Verified
                </p>
              )}
            </div>
            <div>
